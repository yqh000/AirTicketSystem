/**
 * Sample Skeleton for 'deleteFlight.fxml' Controller Class
 */
package spg.UI;
...
public class DeleteFlight {
    ...
    void initialize() {
        assert paneDeleteFlight != null : "fx:id=\"paneDeleteFlight\" was not injected: check your FXML file 'deleteFlight.fxml'.";
        assert buttonCancel != null : "fx:id=\"buttonCancel\" was not injected: check your FXML file 'deleteFlight.fxml'.";
        assert textFlightNum != null : "fx:id=\"textFlightNum\" was not injected: check your FXML file 'deleteFlight.fxml'.";
        assert buttonEnsure != null : "fx:id=\"buttonEnsure\" was not injected: check your FXML file 'deleteFlight.fxml'.";
